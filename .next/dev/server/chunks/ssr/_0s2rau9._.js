...
function useKiosk() {
    ...
    const suggestionTimerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const cancelSuggestionTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (suggestionTimerRef.current) {
            clearTimeout(suggestionTimerRef.current);
            suggestionTimerRef.current = null;
        }
    }, []);
    const hideSuggestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    const scheduleSuggestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((result)=>{
        cancelSuggestionTimer();
        ...
        try {
            ...
            recorder.onstop = async ()=>{
                ...
                const [, transcriptResult] = await Promise.allSettled([
                    sendAudioToAPI(blob),
                    // Deepgram: transcribe so user sees what they said in the text console
                    (async ()=>{
                        try {
                            const fd = new FormData();
                            fd.append('audio', blob, 'speech.webm');
                            fd.append('lang', 'en'); // RequestScreen is always English input
                            ...
                            if (res.ok) {
                                ...
                                if (data.transcript) {
                                    ...
                                    // Keep ref in sync so proceedToChat reads the correct value
                                    userRequestRef.current = data.transcript;
                                    setUserRequest(data.transcript);
                                }
                            }
                        } catch (e) {
                            // Transcription failure is non-critical; NLI analysis continues
    ...
    const submitRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (text)=>{
        ...
        try {
            ...
            if (rulesResult.rawMatches && rulesResult.rawMatches.length > 0) {
                blendedProbabilities = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$nliRules$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NLI_LANGUAGES"].map((lang)=>{
                ...
                if (topProb && topProb.confidence >= 25) {
                    finalDetected = {
                        ...
                        choices: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$nliRules$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NLI_LANGUAGES"].find((l)=>l.code === topProb.code)?.choices || []
                    };
                }
            } else {
...
"[project]/src/components/RequestScreen.jsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/components/RequestScreen.jsx'\n\nUnexpected token. Did you mean `{'}'}` or `&rbrace;`?");
...
function ChatScreen({ active, langCode, chatMessages, onSend, onReset, analysisResult, onChangeLanguage, kioskStatus, showToast }) {
    ...
    const [transcriptFilled, setTranscriptFilled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
        ...
        try {
            ...
            recorder.onstop = async ()=>{
                ...
                try {
                    ...
                    if (transcript) {
                        setInput(transcript);
                        // Focus the input field so the user sees the transcript immediately
                        setTimeout(()=>{
                            inputRef.current?.focus();
                            // Select all text so user can easily replace or edit
                            inputRef.current?.select();
                        }, 50);
                        // Trigger visual highlight flash on the input box
                    ...
                    if (showToast) {
                        const msg = err.message.includes('fetch') || err.message.includes('Failed') ? '⚠️ Backend not running. Start main.py first!' : `Transcription failed: ${err.message}`;
                        showToast(msg, 'error');
                    }
                } finally{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ref: inputRef,
                        type: "text",
                        className: `chat-input-field${transcriptFilled ? ' transcript-filled' : ''}`,
...
//# sourceMappingURL=_0s2rau9._.js.map