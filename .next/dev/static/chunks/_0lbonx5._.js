...
function useKiosk() {
    ...
    const [analysisResult, setAnalysisResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // { probabilities, rawMatches, highlightedHtml, detected }
            ...
            try {
                ...
                rec.onresult = ({
                    "useKiosk.useEffect": (event)=>{
                        ...
                        if (text) {
                            setInputText(text);
                            const a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$nliRules$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeEnglishText"])(text);
    ...
    const runAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useKiosk.useCallback[runAnalysis]": (text)=>{
            if (!text || !text.trim()) return;
            setKioskStatus('thinking');
            setAnalysisComplete(false);
            // Small delay to let user see "Analyzing..." state
            setTimeout({
                "useKiosk.useCallback[runAnalysis]": ()=>{
                    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$nliRules$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeEnglishText"])(text);
                    ...
                    if (resolved) {
                        ...
                        }["useKiosk.useCallback[runAnalysis]"], 1500);
                    } else {
                        // No L1 detected — go straight to English chat
                        setTimeout({
                            "useKiosk.useCallback[runAnalysis]": ()=>proceedToChat('en')
                        }["useKiosk.useCallback[runAnalysis]"], 1800);
                    }
                }
            }["useKiosk.useCallback[runAnalysis]"], 600);
        }
    }["useKiosk.useCallback[runAnalysis]"], []);
    const submitRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useKiosk.useCallback[submitRequest]": (text)=>{
            if (!text || !text.trim()) return;
            runAnalysis(text);
        }
...
_s(useKiosk, "m9tB+Jzbe0cwCszYQck5J7izWOk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0lbonx5._.js.map